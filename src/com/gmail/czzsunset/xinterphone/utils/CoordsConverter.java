package com.gmail.czzsunset.xinterphone.utils;


/**
 * Provider a method to map from WGS-84 to GCJ-02(so called"火星坐标")
 *
 * @author sunset
 *
 */
public class CoordsConverter {
	...
	public static LatLng coordsTransformEarth2Mars(LatLng latlng){
		if( isOutOfChina(latlng)){
			return latlng;
		}
		
		double lat = latlng.lat, lng = latlng.lng, newLat, newLng;
        ...
        newLat = (float) (lat + dLat);
        newLng = (float) (lng + dLon);		
